$(document).ready(function() { 
    $("#fileblock").html(strings.fileblock);
    $("#originalHTMLblock").html(strings.originalHTMLblock);
    $("#parsedresult").html(strings.parsedresult);
    $("#xml").html(strings.xml);
    $("#MCtabhead").html(strings.MCtabhead);
    $("#TFtabhead").html(strings.TFtabhead);
    $("#CQtabhead").html(strings.CQtabhead);
